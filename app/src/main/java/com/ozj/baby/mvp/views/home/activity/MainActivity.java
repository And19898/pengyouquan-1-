...
import com.ozj.baby.base.UserDao;
import com.ozj.baby.event.UploadPhotoUri;
import com.ozj.baby.lotto.lottery.LottoTrendActivity;
...
public class MainActivity extends BaseActivity
    ...
    @Override
    public void toCaipiaoActivity() {
        startActivity(new Intent(this, TrendChartActivity.class));
    }

    @Override
    public void toZoushiActivity() {
        startActivity(new Intent(this, LottoTrendActivity.class));
    }
