...
import com.ozj.baby.webview.net.client.ClientManager;
import com.ozj.baby.webview.tools.file.FileUtils;
import com.ozj.baby.webview.x5.tools.UserAgent;
...
public enum DownLoad {
    ...
    public void download(final String downloadUrl, final String filename, final DownloadCallback callBack, final boolean isShowNotify) {
        download(downloadUrl, CommonUtils.getCacheDir(BabyApplicationLike.get()), filename, callBack, isShowNotify);
    }
